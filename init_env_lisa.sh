...
pip install tensorflow-1.13.1-cp27-cp27mu-linux_x86_64.whl --user --force-reinstall --no-cache --ignore-installed
pip install scikit-learn keras --no-cache --user
CC=mpicc CXX=mpicxx pip install horovod --no-cache --force-reinstall --ignore-installed --user
