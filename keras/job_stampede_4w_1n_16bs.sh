#!/bin/bash -l
#SBATCH -J 3DGAN_1w_1n_bs16_sun
#SBATCH -o 3DGAN_1w_1n_bs16_sun_output.txt
#SBATCH -e 3DGAN_1w_1n_bs16_sun_errors.txt
...
mkdir /scratch/04653/damianp/3DGAN_1w_1n_bs16_sun
...
mpirun -np ${TOTAL_WORKERS} \
 ...
 --weightsdir='/scratch/04653/damianp/3DGAN_1w_1n_bs16_sun' \
 --intraop ${INTRA_T} \
 --interop ${INTER_T}
